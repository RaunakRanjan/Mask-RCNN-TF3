...
class MaskRCNN():
    ...
    def dice_coef(self,y_true, y_pred):
     ...
     return (2. * intersection + self.smooth) / (tf.reduce_sum(y_true) + tf.reduce_sum(y_pred) + smooth)
    ...
    def compile(self, learning_rate, momentum):
        ...
        #    optimizer=optimizer,
        #   loss=self.dice_loss,metrics=metrics)
        ...
        for name in loss_names:
            ...
            self.keras_model.add_loss(lambda: tf.reduce_mean(layer.output, keepdims=True))
        ...
        for name in loss_names:
            ...
            self.keras_model.add_metric(lambda: tf.reduce_mean(layer.output, keepdims=True),name=name)
